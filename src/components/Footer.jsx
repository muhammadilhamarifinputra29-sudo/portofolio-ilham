    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://www.instagram.com/ilhmarffnp/"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://wa.me/089654718654"><i className="ri-whatsapp-fill ri-2x"></i></a>
          <a href="https://www.tiktok.com/@donthinkaboutthat"><i className="ri-tiktok-fill ri-2x"></i></a>
        </div>
